...
const AnnouncementBar: React.FC = () => {
  const handleTriggerDonate = (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault();
      ...
      <div className="relative w-full overflow-hidden whitespace-nowrap">
        <div className="inline-block pl-[100%] animate-[marquee_15s_linear_infinite] hover:[animation-play-state:paused]">
          <span className="text-sm font-medium tracking-wide flex items-center gap-1.5 select-none pr-4">
            ...
            <a
              href="#"
              onClick={handleTriggerDonate}
              className="text-amber-300 font-bold underline hover:text-amber-200 transition-colors mx-1 cursor-pointer"
            >
              Buy me a Coffee
            </a>
